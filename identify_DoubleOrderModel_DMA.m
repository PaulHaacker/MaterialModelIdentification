function par_norm_lsqnonlin = identify_DoubleOrderModel_DMA(omega_data, storage_data, loss_data, initial_guess,weight_loss)
...
%   initial_guess        - Initial guess for the parameters to be identified.
...
par_norm_lsqnonlin = lsqnonlin(@(p) diffFcn(storage_data, loss_data, weight_loss, ComplexMod_DoubleOrderModel(p,omega_data)), ...
